...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        callback_data_with_password (``bytes``, *optional*):
            ...
            query to the bot. Data to be sent to the bot via a callback query.
        ...
        switch_inline_query (``str``, *optional*):
            If set, pressing the button will prompt the user to select one of their chats and insert the bot's
            username and inline query in the input field.

        switch_inline_query_current_chat (``str``, *optional*):
            If set, pressing the button will insert the bot's username and inline query in the current chat's input.
        ...
        pay (``bool``, *optional*):
            Pass True, to send a Pay button. Substrings `⭐` and `XTR` in the button's text will be replaced with
            a Telegram Star icon. Available in :meth:`~pyrogram.Client.send_invoice`.
            **NOTE**: This type must be first in the row and only allowed in invoice messages.
    ...
    def read(b: "raw.base.KeyboardButton"):
        ...
        if isinstance(b, raw.types.KeyboardButtonCallback):
            # Try decode data to keep it as string, but fallback to bytes on error.
            try:
                data = b.data.decode()
    ...
    async def write(self, client: "pyrogram.Client"):
        ...
        # Prefer `callback_data_with_password` if present; otherwise use plain `callback_data`.
